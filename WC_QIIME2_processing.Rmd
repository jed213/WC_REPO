...
# filter taxa with no phylum, not bacteria, or are mitochondriaor chloroplasts
qiime taxa filter-table \
  --i-table table-filtered.qza \
  --i-taxonomy taxonomy.qza \
  --p-include p__,d__Bacteria \
  --p-exclude mitochondria,chloroplast \
  --o-filtered-table table-pfilt-no-mitochloro.qza
```
...
qiime taxa barplot \
  --i-table table-pfilt-no-mitochloro.qza \
  --i-taxonomy taxonomy.qza \
  --m-metadata-file fecal_qiime_metadata.txt \
...
qiime feature-table summarize \
  --i-table table-pfilt-no-mitochloro.qza \
  --o-visualization table-pfilt-no-mitochloro.qzv \
  --m-sample-metadata-file fecal_qiime_metadata.txt
```
